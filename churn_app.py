...
model = load('Churn_XGboost.joblib')

#model.predict([[10, 0, 2, 100, 100]])

# Create a Streamlit app
st.title("Customer Churn Prediction App") #Add title to the page

# Input fields for feature values on the main screen
st.header("Enter Customer Information") # Add Header
...
print(tenure, internet_service, contract, monthly_charges, total_charges)
